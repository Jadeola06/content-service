...
public class FunctionalException extends RuntimeException {
    ...
    FunctionalException(String messageTemplate, FunctionalErrorCode errorCode, String code, Throwable cause, String... arguments) {
        super(format(messageTemplate, arguments), cause);
        this.errorCode = errorCode;
    }

    FunctionalException(FunctionalErrorCode errorCode, String... arguments) {
        this(errorCode.getMessageTemplate(), errorCode, errorCode.getCode(), null, arguments);
    }
